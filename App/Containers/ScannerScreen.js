...
import { Animated, Keyboard, View, Text, ScrollView, TouchableOpacity } from 'react-native'
...
class ScannerScreen extends React.Component {
  ...
  handleBarCodeRead = ({ data, type }) => {
    ...
    if (mode === MODE_ENUM.photographer) {
      this.navigate('CameraScreen', { transition: 'slideInTransition' })
    }
  }
          ...
          {!navigation.isFocused() ? null : (
            ...
            >
              <View style={Styles.topActions}>
                <Button style={Styles.accountButton} image={Images.account} onPress={this.handleAccount} />
...
export default enhance(withNavigationFocus(ScannerScreen, 'ScannerScreen'))
