        ...
        return (
            <Animatable.View style={styles.container}>
                <Animatable.View style={styles.imageWrapper}>
                    <Animatable.Image source={Images.barcodeBlack} style={styles.barCode}/>
                </Animatable.View>
                ...
                <TouchableOpacity style={styles.selectOption}>
                    <Animatable.View style={[{width: 39 * scale.widthRatio, height: 32 * scale.heightRatio}]}>
                        <Animatable.Image source={Images.camera} style={styles.option}/>
                    </Animatable.View>
                    <Animatable.View>
                    ...
                    <Animatable.View style={styles.arrowImageWrapper}>
                        <Animatable.Image source={Images.arrowRight} style={styles.arrow} />
                    </Animatable.View>
                </TouchableOpacity>
                <TouchableOpacity style={styles.selectOption}>
                    <Animatable.View style={[{width: 35 * scale.widthRatio, height: 48 * scale.heightRatio}]}>
                        <Animatable.Image source={Images.checkProduct} style={styles.option}/>
                    </Animatable.View>
                    <Animatable.View>
